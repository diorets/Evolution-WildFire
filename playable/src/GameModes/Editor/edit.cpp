...
#include "Glut/myGlut.h"           // glutSwapBuffers
#include "ErrorHandle/error.h"     // quit

#include "Generation/generation.h" // createCreature
#include "Generation/genes.h"      // Various genes
#include "Visual/basic.h"          // Various Shapes
#include "Functional/list.h"       // addToBack
#include "Visual/objects.h"        // Sight, ground
...
//    dist += editorLength;
    ...
    posi targetLoc;
    targetLoc.x = cameraPos.x + dist * cameraDir.x;
    targetLoc.y = cameraPos.y + dist * cameraDir.y;
    targetLoc.z = cameraPos.z + dist * cameraDir.z;
